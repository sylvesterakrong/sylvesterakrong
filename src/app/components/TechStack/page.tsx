...
const techstack = () => {
  return (
    <section className='object-cover mb-10 mt-15'>
      <div className='text-leftfont-semibold'>
        <h3 className='lg:p-9 text-teal-600 text-xl font-medium md:lg'> I use the following Tech stack when developing software</h3>
      </div>
